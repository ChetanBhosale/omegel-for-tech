...
/**
 * Full-screen branded loading state. Reuses the match page's cinematic
 * background so transitions feel seamless.
 */
export function LoadingScreen({ message = "Loading…" }: { message?: string }) {
  return (
    <div className="relative flex min-h-svh flex-col items-center justify-center overflow-hidden bg-background">
      {/* Background image + dark overlay (matches the /match page) */}
      <div
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        {/* Pulsing glass orb with an orbiting ring */}
